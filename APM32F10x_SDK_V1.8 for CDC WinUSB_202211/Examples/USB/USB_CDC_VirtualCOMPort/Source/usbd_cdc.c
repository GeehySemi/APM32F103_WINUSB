...
#if USB_SUP_WINSUB
    usbParam.pWinUsbOsFeatureDesc = (USBD_Descriptor_T *)&g_winusbOsFeatureDescriptor;
    usbParam.pWinUsbOsPropertyDesc = (USBD_Descriptor_T *)&g_winusbOsPropertyDescriptor;
#endif
